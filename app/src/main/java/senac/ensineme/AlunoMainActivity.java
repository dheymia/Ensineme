...
public class AlunoMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference refDem = firebase.getReference("usuarios/" + idUsuario + "/demandas");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alterar = false;
                Intent intent = new Intent(AlunoMainActivity.this, DemandaActivity.class);
    ...
    private View.OnClickListener onItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            Intent busca = new Intent(AlunoMainActivity.this, AlunoBuscaActivity.class);
            startActivity(busca);
        }
    };
    ...
    private ValueEventListener ListenerGeral = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            CategoriaProfAdapter adapter = new CategoriaProfAdapter(categoriaList, AlunoMainActivity.this);
    ...
    private final View.OnClickListener onItemClickListenerDemandas = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(AlunoMainActivity.this);
  ...
  /*      builder.setNegativeButton("Voltar", new DialogInterface.OnClickListener() {
    ...
    private ValueEventListener ListenerGeralDemandas = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            DemandaAluAdapter adapterDemandas = new DemandaAluAdapter(demandasList, AlunoMainActivity.this);
    ...
    private View.OnClickListener clickConsultar = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            btnSelecionaProposta.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    validar = true;
                    Intent oferta = new Intent(AlunoMainActivity.this, OfertaValidaActivity.class);
                    startActivity(oferta);
                }
            });

            recyclerOfertas.setHasFixedSize(true);
            recyclerOfertas.setLayoutManager(new LinearLayoutManager(AlunoMainActivity.this, LinearLayoutManager.VERTICAL, false));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.acaoPesquisar) {
            Intent novaConfig = new Intent(getBaseContext(), AlunoBuscaActivity.class);
            startActivity(novaConfig);
            categoria = "Todas";
        }
